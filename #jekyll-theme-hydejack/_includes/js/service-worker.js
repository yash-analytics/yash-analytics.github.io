...
const SHELL_CACHE = "shell-9.0.3--{{ cache_version }}--{{ site_key }}";
...
const SHELL_FILES = [
  "{{ '/assets/css/hydejack-9.0.3.css' | relative_url }}",
  "{{ '/assets/js/search-worker-9.0.3.js' | relative_url }}",
...
const PRE_CACHED_ASSETS = [
  '{{ "/assets/icons/favicon_.ico" | relative_url }}',
